...
OutputDir=C:\Projects\web_portal\agent\dist
OutputBaseFilename=WebPortalAccessAgent_Setup
PrivilegesRequired=admin
SetupIconFile=C:\Projects\web_portal\agent\icon.ico

[Files]
Source: "C:\Projects\web_portal\agent\dist\WebPortalAccessAgent.exe"; DestDir: "{app}"; Flags: ignoreversion
